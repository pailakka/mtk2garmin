...
ogr2ogr --config OGR_WFS_PAGE_SIZE 5000 --debug on -nln syvyyskayra_v -f "ESRI shapefile" inputdata/syvyyskayra_v.shp WFS:https://extranet.liikennevirasto.fi/inspirepalvelu/rajoitettu/wfs?typeName=rajoitettu:syvyyskayra_v
ogr2ogr --config OGR_WFS_PAGE_SIZE 5000 --debug on -nln syvyyspiste_p -f "ESRI shapefile" inputdata/syvyyspiste_p.shp WFS:https://extranet.liikennevirasto.fi/inspirepalvelu/rajoitettu/wfs?typeName=rajoitettu:syvyyspiste_p
