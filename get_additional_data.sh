...
curl --fail --verbose --retry 5 --retry-delay 30 -o inputdata/kesaretkeilyreitit.gml "http://www.retkikartta.fi/wfs/a9e9a1840ee69e32d59af86dd1ffeb44/?request=GetFeature&typeName=retkikartta_euref:kesaretkeilyreitit&outputFormat=GML2&service=wfs"
curl --fail --verbose --retry 5 --retry-delay 30 -o inputdata/ulkoilureitit.gml "http://www.retkikartta.fi/wfs/a9e9a1840ee69e32d59af86dd1ffeb44/?request=GetFeature&typeName=retkikartta_euref:ulkoilureitit&outputFormat=GML2&service=wfs"
curl --fail --verbose --retry 5 --retry-delay 30 -o inputdata/luontopolut.gml "http://www.retkikartta.fi/wfs/a9e9a1840ee69e32d59af86dd1ffeb44/?request=GetFeature&typeName=retkikartta_euref:luontopolut&outputFormat=GML2&service=wfs"
curl --fail --verbose --retry 5 --retry-delay 30 -o inputdata/point_dump.gml "http://www.retkikartta.fi/wfs/a9e9a1840ee69e32d59af86dd1ffeb44/?request=GetFeature&typeName=retkikartta_euref:point_dump&outputFormat=GML2&service=wfs"
